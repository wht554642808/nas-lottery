...
<style lang="less" scoped>
    ...
    .layer-close{ display: block; position: absolute; right: 10px; top: 12px; width: 50px; height: 50px; z-index: 10; color: #333; font-size: 20px; line-height: 50px; text-align: center;
    &:hover{
     @include opacity(60);
     }
    }
    .layer-header{ height: 50px;
        line-height: 50px;
        text-align: center;
        overflow: hidden; font-size: 22px; padding-left: 15px; position: relative; border: 1px solid #e9eaec; color: #333; border-radius: 5px 5px 0 0; -moz-user-select: none; -webkit-user-select: none; }
    .layer-scroll{ overflow-x: hidden; overflow-y: auto; }
    .layer-content{ padding: 30px 50px;
    &.layer-content-text{ text-align: center;
    .layer-text{ display: inline-block; text-align: left;font-size: 15px;line-height: 1.5;
        a {
            color: #31C5D2;
            &:hover {
    ...
    .layer-footer{ text-align: center; margin-bottom: 25px; margin-top: 20px; overflow: hidden;
    .btn{
        margin: 0 10px;
        height: 44px;
        padding: 0 40px;
